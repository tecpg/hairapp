...
public class Image2 implements Serializable {
    ...
    public Image2(String url, String name, String status, String fbk_id, String insta_id, String phone, String email, String image_path, String album_name, String timestamp) {
        this.url = url;
        this.name = name;
        this.status = status;
        this.fbk_id = fbk_id;
